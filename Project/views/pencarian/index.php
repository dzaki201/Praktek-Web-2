        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <h3 class="text-center mb-5">Pencarian</h3>
                        <form action="" method="post">
                                ...
                                <div class="bootstrap-select fm-cmp-mg col-sm-10 ">
                                    <select name="id_rute" class="selectpicker">
                                        ...
                                        <?php foreach ($rute as $data): ?>
                                            <option value="<?php echo $data['id_rute']; ?>" <?php echo isset($_POST['id_rute']) && $_POST['id_rute'] == $data['id_rute'] ? 'selected' : ''; ?>>
                            ...
                            <div class="row">
                                ...
                                <div class="bootstrap-select fm-cmp-mg col-sm-10">
                                    <select name="tipe" class="selectpicker" >
                                        ...
                                        <option value="Bus Double Decker" <?php echo isset($_POST['tipe']) && $_POST['tipe'] == 'Bus Double Decker' ? 'selected' : ''; ?>>Bus Double Decker
                                        </option>
                                    </select>
                                </div>
                            </div>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($rute_tersedia) {
                    ...
                    // Tampilkan tabel bus jika rute tersedia
                    echo '<div class="normal-table-list">
                        <table border="1" class="table table-bordered border-primary table-striped">
                            ...
                            <tbody class="table-striped">'; // Add the .table-striped class to the tbody
