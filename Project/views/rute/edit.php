            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-app"></i> Tambah Data</a>
                        </li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        ...
                        <?php if ($ruteData) { ?>
                        <div class=" row">
                            <label class="col-sm-2 col-form-label">ID Rute</label>
